...
<div class="all_student fix">
		...
		<div  class="fix" style="background:#ddd;padding:20px;">
			<span style="float:left;"><a style="color:#fff;" href="class_att.php"><button style="background:#4b74fa;border:none;color:#fff;padding:10px;">Take Attendance</button></a></span>
	...
	<form action="" method="post">
		...
		<center>
		<span><input style="<text-align:right></text-align:right>;background:#4b74fa;;border:none;color:#fff;padding:8px 100px;" type="submit" name="submit" value="Update" /></span>
		</center>
