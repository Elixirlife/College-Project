...
<div class="all_student fix">
		<div>
		<p style="text-align:center;color:#fff;background:#4b74fa;margin:0;padding:8px;"><?php echo "Name: ".$name."<br>ID: ".$stid."<br>Semester: " . $semester; ?></p>
		</div>
			<?php
		...
		<table class="tab_one" style="text-align:center;">
			<tr>
				<th style="text-align:center;background:#4b74fa">Subject</th>
				<th style="text-align:center;background:#4b74fa">Marks</th>
		...
		<div class="back fix">
				<p style="text-align:center"><a href="view_result.php?vr=<?php echo $stid?>&vn=<?php echo $name?>"><button class="editbtn" style="background:#4b74fa">go to result page</button></a></p>
			</div>
</div>
