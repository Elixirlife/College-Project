...
<div class="all_student fix">
		...
		<div  class="fix" style="background:#ddd;padding:20px;">
			<span style="float:left;"><a style="color:#fff;" href="att_add.php"><button style="background:#4b74fa;border:none;color:#fff;padding:10px;">Add student</button></a></span>
			<span style="float:right;"><a style="color:#fff;" href="att_view.php"> <button style="background:#4b74fa;border:none;color:#fff;padding:10px;">View Attendance</button></a></span>
		</div>
		<?php
	...
	<form action="" method="post">
		...
		<table class="tab_one" style="text-align:center;">
			<tr>
				<th style="text-align:center; background:#4b74fa">SL</th>
				<th style="text-align:center;background:#4b74fa">Name</th>
				<th style="text-align:center;background:#4b74fa">ID</th>
				<th style="text-align:center;background:#4b74fa">Attendance</th>
				<th style="text-align:center;background:#4b74fa">Delete student</th>
		...
		<center>
		<span><input style="<text-align:right></text-align:right>;background:#4b74fa;border:none;color:#fff;padding:8px 100px;" type="submit" name="submit" value="Submit" /></span> <br>
		</center>
