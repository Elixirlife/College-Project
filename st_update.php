...
<div class="profile">
			<h3 style="font-size:18px;text-align:center;background:#ffffff;color:#000000;padding:10px;margin:0">Update Your Profile</h3>							
				<?php
			...
			<div class="back fix">
				<p style="text-align:center"><a href="st_profile.php"><button class="editbtn" style="background:#4b74fa">Back to your Profile</button></a></p>
			</div>
</div>
