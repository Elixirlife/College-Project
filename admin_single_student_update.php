...
<div class="profile">
			<h3 style="font-size:18px;text-align:center;background:#ffffff;color:#000000;padding:10px;margin:0">Update Profile</h3>							
				<?php
			...
			<div class="back fix">
				<p style="text-align:center"><a href="admin_all_student.php"><button class="editbtn" style="background:#3498db;">Back to student Profile</button></a></p>
			</div>
</div>
