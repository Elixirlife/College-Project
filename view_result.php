...
<div class="all_student fix">
	...
	<!--Infomation of student-->
		<div>
	<p style="text-align:center;color:#fff;background:#4b74fa;margin:0;padding:8px;"><?php echo "Name: ".$name."<br>Student ID: " . $stid; ?></p>
	</div>	
	<div>
	<p style="float:left;margin:0 0 5px 0;width:100%;text-align:center;"><a href="view_cgpa.php?vr=<?php echo $stid; ?>&vn=<?php echo $name; ?>"><button class="editbtn" style="background:#4b74fa;">View cgpa & completed course</button></a></p>
	</div>
	...
	//select semester
		...
		?>
			<p style="float:left; text-align:right;margin:20px 0;width:49%"><a href="st_result_update.php?ar=<?php echo $stid?>&seme=<?php echo $semester?>&vn=<?php echo $name?>"><button class="editbtn" style="background:#4b74fa">Edit Result</button></a></p>
		<?php 
				}
		?>
		
			<p style="float:right;text-align:left;margin:20px 0;width:49%"><a href="st_result.php"><button class="editbtn" style="background:#4b74fa">Back to list</button></a></p>
