...
<div class="all_student fix">
	<h3 style="text-align:center;color:#000000;margin:0;padding:5px;background:#ffffff">Attendance Management</h3>
		<div  class="fix" style="background:#ddd;padding:20px;">
			...
			<span style="float:right;"> <button style="background:#4b74fa;border:none;color:#fff;padding:10px;"><a style="color:#fff;" href="class_att.php">Take Attendance</a></button></span>
		</div>

		<table class="tab_one" style="text-align:center;">
			<tr>
				<th style="text-align:center;background:#4b74fa;">SL</th>
				<th style="text-align:center;background:#4b74fa;"> Attendance Date</th>
				<th style="text-align:center;background:#4b74fa;">Action</th>
