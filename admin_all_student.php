...
<div class="all_student" >
	...
	<div class="search_st">
		...
		<div class="hdinfo"><h3 style="background:#ffffff; color:#000000">All Registered Student List </h3></div>

		<div class="search">
		<form action="admin_search_student.php" method="GET" style="background:#ffffff; color:#000000">
		...
		<table class="tab_one">
			<tr>
				<th style="background:#5c5fff; color:#000000">SL</th>
				<th style="background:#5c5fff; color:#000000">Name</th>
				<th style="background:#5c5fff; color:#000000">ID</th>
				<th style="background:#5c5fff; color:#000000">Show Profile</th>
				<th style="background:#5c5fff; color:#000000">Edit</th>
				<th style="background:#5c5fff; color:#000000">Delete</th>
				<th style="background:#5c5fff; color:#000000">Photo</th>
			</tr>
			<?php 
			$i=0;
