...
<div class="all_student fix">
	...
	<!--Infomation of student-->
		<div>
	<p style="text-align:center;color:#000000;background:#4b74fa;margin:0;padding:8px;"><?php echo "Name: ".$name."<br>Student ID: " . $stid; ?></p>
	</div>		
	...
	<div class="fix">
	<p style="float:left;margin:0 0 3px 0;width:100%;text-align:center;"><a href="view_single_cgpa.php?vr=<?php echo $stid; ?>&vn=<?php echo $name; ?>"><button class="editbtn" style="background:#4b74fa">View CGPA & Complete Course</button></a></p>
	</div>
	<?php
	//select semester
		...
		?>
			...
			<p style="float:right;text-align:left;margin:20px 0;width:58%"><a href="st_profile.php"><button class="editbtn" style="background:#4b74fa">Back to profile</button></a></p>
