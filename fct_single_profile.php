...
?>
	<div class="faculty">
		<p style="font-size:18px;text-align:center;background:#ffffff;color:#000000;padding:10px;margin:0">Welcome : <?php echo $funame; ?> <i class="fa fa-check-circle" aria-hidden="true"></i></p>
