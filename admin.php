...
<div class="admin_profile">
	...
	<div class="section">
			...
			<ul>
				...
				<li><a href="st_reg.php">Add New Student</a></li>
				<li><a href="http://localhost/Online-notice-board-in-php-and-mySQL-master/admin/index.php">notice</a></li>
				<li><a href="Student List.pdf"><button>Download Student List</button></a></li>
			</ul>
	</div>
	<div class="section">
			<h3>Faculty</h3>
