...
<div  class="fix">	
	<p style='text-align:center;background:#ddd;color:#000000;padding:5px;width:84%;margin:0 auto'>All Completed Course & Grade</p>
</div>
	<?php
	//select semester
			$i=0;
		...
		<div class="back fix">
			<p style="text-align:center"><a href="view_single_result.php?vr=<?php echo $stid?>&vn=<?php echo $name?>"><button class="editbtn" style="background:#4b74fa">go to result page</button></a></p>
		</div>
